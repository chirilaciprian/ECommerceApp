...
export const getCartById = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
...
export const createCart = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        next(new AppError("Failed to create cart", errorCodes.INTERNAL_SERVER_ERROR));
    }
}
...
export const deleteCart = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        next(new AppError("Failed to delete cart", errorCodes.INTERNAL_SERVER_ERROR));
    }
}
...
export const updateCart = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        next(new AppError("Failed to update cart", errorCodes.INTERNAL_SERVER_ERROR));
    }
}
